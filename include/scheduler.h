...
*					@interval_in_sec: the amount of seconds that should pass
...
*				it's own run the task will not be found. Please use
*				the action func return value to remove a running task from
*				@scheduler 
*   @params: 		@scheduler: pre allocated scheduler
